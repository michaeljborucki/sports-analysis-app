...
SAMPLE_BETS = pd.DataFrame([
    {"date": "2026-04-01", "game": "MI vs CSK", "bet_type": "moneyline", "side": "team_a",
     "odds": -150, "sim_prob": 0.62, "edge": 0.06, "kelly_pct": 0.02, "result": "W", "profit": 0.67},
    {"date": "2026-04-01", "game": "MI vs CSK", "bet_type": "total_runs", "side": "under 340.5",
     "odds": -110, "sim_prob": 0.58, "edge": 0.05, "kelly_pct": 0.01, "result": "L", "profit": -1.0},
    {"date": "2026-04-02", "game": "RCB vs KKR", "bet_type": "moneyline", "side": "team_b",
     "odds": 120, "sim_prob": 0.55, "edge": 0.07, "kelly_pct": 0.03, "result": "W", "profit": 1.2},
    {"date": "2026-04-02", "game": "RCB vs KKR", "bet_type": "total_runs", "side": "over 335.5",
...
def test_recommend_adjustments():
    by_type = {
        ...
        "total_runs": {"total": 25, "roi": -12.0, "win_rate": 0.42},
    }
    by_edge = {}
...
def test_compute_model_brier_scores():
    preds_df = pd.DataFrame([
        {"model": "kimi", "bet_type": "moneyline", "sim_prob": 0.60, "side": "team_a"},
        {"model": "kimi", "bet_type": "moneyline", "sim_prob": 0.55, "side": "team_a"},
        {"model": "gpt4o", "bet_type": "moneyline", "sim_prob": 0.70, "side": "team_a"},
    ])
    bets_df = pd.DataFrame([
        {"bet_type": "moneyline", "result": "W", "date": "2026-03-28", "game": "MI vs CSK"},
        {"bet_type": "moneyline", "result": "L", "date": "2026-03-29", "game": "RCB vs KKR"},
    ])
...
def test_update_model_weights_creates_file():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        brier_scores = {
            "kimi": {"moneyline": 0.20, "total_runs": 0.25},
            "gpt4o": {"moneyline": 0.15, "total_runs": 0.30},
        }
