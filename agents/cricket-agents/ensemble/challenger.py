...
CHALLENGER_SYSTEM_PROMPT = """You are a final-check analyst reviewing a cricket betting ensemble's output.
...
CRICKET-SPECIFIC BLIND SPOTS TO CHECK:
1. PITCH CONDITIONS: Deteriorating pitches, toss advantage
2. DEW FACTOR: Evening matches favor chasing teams
3. VENUE HISTORY: Ground-specific scoring patterns
4. SQUAD CHANGES: Last-minute XI changes, overseas player rotation
5. FORMAT ADJUSTMENT: Players transitioning between Test/ODI/T20 form
6. WEATHER: Rain interruptions affecting DLS targets
