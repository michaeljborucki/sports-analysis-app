...
Tracks already-sent bets in data/notifications_sent.json so repeated pipeline
runs don't re-send the same picks.
"""
import json
import logging
import os
...
def send_notifications(game_date: str | None = None,
    ...
    """Filter today's bets, format, dispatch to Discord.

    Returns {bets_total, bets_filtered, bets_new, sent, dry_run, discord_enabled}.
    """
