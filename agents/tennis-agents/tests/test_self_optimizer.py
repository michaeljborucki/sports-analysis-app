...
SAMPLE_BETS = pd.DataFrame([
    {"date": "2026-06-01", "game": "Djokovic vs Alcaraz", "bet_type": "moneyline", "side": "player_a",
     "odds": -150, "sim_prob": 0.62, "edge": 0.06, "kelly_pct": 0.02, "result": "W", "profit": 0.67},
    {"date": "2026-06-01", "game": "Djokovic vs Alcaraz", "bet_type": "total_games", "side": "under 22.5",
     "odds": -110, "sim_prob": 0.58, "edge": 0.05, "kelly_pct": 0.01, "result": "L", "profit": -1.0},
    {"date": "2026-06-02", "game": "Sinner vs Medvedev", "bet_type": "moneyline", "side": "player_a",
     "odds": 120, "sim_prob": 0.55, "edge": 0.07, "kelly_pct": 0.03, "result": "W", "profit": 1.2},
    {"date": "2026-06-02", "game": "Sinner vs Medvedev", "bet_type": "game_handicap", "side": "player_a -3.5",
...
def test_recommend_adjustments():
    by_type = {
        ...
        "total_games": {"total": 25, "roi": -12.0, "win_rate": 0.42},
    }
    by_edge = {}
...
def test_compute_model_brier_scores():
    preds_df = pd.DataFrame([
        {"model": "kimi", "bet_type": "moneyline", "sim_prob": 0.60, "side": "player_a"},
        {"model": "kimi", "bet_type": "moneyline", "sim_prob": 0.55, "side": "player_a"},
        {"model": "gpt4o", "bet_type": "moneyline", "sim_prob": 0.70, "side": "player_a"},
    ])
    bets_df = pd.DataFrame([
        {"bet_type": "moneyline", "result": "W", "date": "2026-06-01", "game": "Djokovic vs Alcaraz"},
        {"bet_type": "moneyline", "result": "L", "date": "2026-06-02", "game": "Sinner vs Medvedev"},
    ])
...
def test_update_model_weights_creates_file():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        brier_scores = {
            "kimi": {"moneyline": 0.20, "game_handicap": 0.25},
            "gpt4o": {"moneyline": 0.15, "game_handicap": 0.30},
        }
