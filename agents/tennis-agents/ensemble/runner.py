...
from simulate import TENNIS_SYSTEM_PROMPT, parse_simulation_result
...
def run_single_model(
    ...
    Args:
        system_prompt: Override the default TENNIS_SYSTEM_PROMPT (used by challenger).
    """
    ...
    sys_prompt = system_prompt or TENNIS_SYSTEM_PROMPT
