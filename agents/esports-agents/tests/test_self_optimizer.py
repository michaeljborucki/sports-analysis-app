...
SAMPLE_BETS = pd.DataFrame([
    {"date": "2026-04-01", "game": "NaVi vs FaZe", "bet_type": "moneyline", "side": "team_a",
     "odds": -150, "sim_prob": 0.62, "edge": 0.06, "kelly_pct": 0.02, "result": "W", "profit": 0.67},
    {"date": "2026-04-01", "game": "NaVi vs FaZe", "bet_type": "total_maps", "side": "under 2.5",
     "odds": -110, "sim_prob": 0.58, "edge": 0.05, "kelly_pct": 0.01, "result": "L", "profit": -1.0},
    {"date": "2026-04-02", "game": "T1 vs GenG", "bet_type": "moneyline", "side": "team_b",
     "odds": 120, "sim_prob": 0.55, "edge": 0.07, "kelly_pct": 0.03, "result": "W", "profit": 1.2},
    {"date": "2026-04-02", "game": "T1 vs GenG", "bet_type": "map_handicap", "side": "underdog",
...
def test_update_model_weights_creates_file():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        brier_scores = {
            "kimi": {"moneyline": 0.20, "map_handicap": 0.25},
            "gpt4o": {"moneyline": 0.15, "map_handicap": 0.30},
        }
        bet_slots = ["moneyline", "map_handicap", "total_maps"]
        update_model_weights(brier_scores, bet_slots=bet_slots, weights_path=weights_path)
