...
def run_single_model(
    ...
    Args:
        system_prompt: Game-specific system prompt (required for production use).
                       Will be provided by the orchestrator after Task 8 integration.
                       Logs a warning if not supplied.
    """
    ...
    if system_prompt is None:
        logger.warning("%s: no system_prompt provided — game_config not yet wired (Task 8)", model_key)
